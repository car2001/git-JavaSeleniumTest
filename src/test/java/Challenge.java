...
public class Challenge {
    ...
    @Test
    public void selecionarScrollCounter() throws InterruptedException {
        //Iniciar propiedades
        System.setProperty("webdriver.chrome.driver","drivers/chromedriver.exe");
        //Iniciamos chrome
        WebDriver driver = new ChromeDriver();
        ...
        driver.findElement(By.xpath("//div[@id='__content0-__xmlview2--container-4']")).click();
        Thread.sleep(4000);
        //Ingresamos A Reusable Component
        driver.findElement(By.xpath("//span[normalize-space()='Reusable Component']")).click();
        Thread.sleep(1000);
        //Ingresamos AL Counter
        driver.findElement(By.xpath("//span[normalize-space()='Counter']")).click();
        Thread.sleep(3000);
        //Ingresamos a ver más counter
        WebElement Element = driver.findElement(By.id("__xmlview5--listObject-triggerText"));
        js.executeScript("arguments[0].scrollIntoView();", Element); // scroll hasta ver el elemento
        Element.click(); //Click al elemento requerido
        Thread.sleep(2000);
        //Buscamos nuestro Counter
        driver.findElement(By.xpath("//div[normalize-space()='test']")).click();
        //Logica para acceder al boton eliminar
        String cadenaID = driver.findElement(By.xpath("//div[normalize-space()='test']")).getDomAttribute("id");
        String postDelete = "imgDel-inner";
        char caracter = '-';
        String idDelete = concatenarCadena(cadenaID,postDelete,caracter);
        //driver.findElement(By.id(idDelete)).click();
        String respuesta = js.executeScript("return document.URL").toString();
